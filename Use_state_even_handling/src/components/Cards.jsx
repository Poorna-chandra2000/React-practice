             ...
             carddata.map((card,index)=>{
                 ...
                 return ( <>
                            <div className="flex flex-col w-[11rem] justify-center items-center" key={index}>
                              ...
                              <button className={`${card.instock?"bg-blue-500 text-blue-50":"bg-pink-600 text-blue-50"} text-2xl text-green-950 w-fit h-fit shadow-md p-1 drop-shadow-sm accent-transparent rounded-lg self-start ml-4`}>
